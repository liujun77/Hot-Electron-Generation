...
#define fact_max    900               // maxium n stored in fact[n]=n!
#define fact2_max   200               // maxium n stored in fact2[n]
long numero  *fact,                        // fact[n] = n!
        *fact2,                       // fact2[n]=(n!)^(1/2)
        *ffact,                       // ffact[n]= n!!
...
int init_fact(void)                   // init fact (n!) and fact2 (n!^0.5)
{
  ...
  fact   = new long numero [fact_max+1];       fact_initialized=1;
  fact2  = new long numero [fact2_max+1];
...
{                                     // and ffact2 (gamma(n/2))
  ...
  ffact   = new long numero [fact2_max+1];     ffact_initialized=1;
  ffact2  = new long numero [fact2_max+1];
